...
~~~shell
# WSL配置为镜像网络，为了方便使用代理
# 打开家目录下 .wslconfig 使用该配置, -->	C:\Users\82542\.wslconfig 
...
# 建议依赖，因为开始没看到，所以我用上面方法缺什么安装的什么，没安装下面的
sudo apt update
...
./install.sh esp32s3 # 如果想支持所有 ESP32 系列，用 ./install.sh all
...
# 如果你想要 USB + CDC REPL + Octal PSRAM（新版支持更好）
# 似乎忘记尝试了，这个版本不知道USB是否和C3一样好用，默认版本太难用
...
# 方式2: 使用manifest.py 指定
#  manifest 或加文件后，必须 clean + 重新 make，否则变更不生效。
~~~
...
~~~shell
# 下载乐鑫摄像头组件
cd C:\Users\82542\code\py\MicroPython\camera_lr\open_code
git clone https://github.com/espressif/esp32-camera

# 摄像头组件还必须依赖一个espressif__esp_jpeg组件，如果忘记在哪下载，以及部分IDF和MPY冲突无法下载，可以在本地编译后复制出来
~~~
...
~~~json
{
    ...
    "configurations": [
        {
            "name": "ESP32-S3 + MicroPython (manual)",
            "compilerPath": "C:/Espressif/tools/xtensa-esp-elf/esp-14.2.0_20241119/xtensa-esp-elf/bin/xtensa-esp32s3-elf-gcc.exe",
            ...
            "includePath": [
                "${workspaceFolder}/**",
                "C:\\Users\\82542\\code\\py\\MicroPython\\mod\\camera_lr\\**",
                /* toolchain libc */
                "C:/Espressif/tools/xtensa-esp-elf/esp-14.2.0_20241119/xtensa-esp-elf/picolibc/include",
                /* ESP-IDF 基础 */
                "C:/Users/82542/test_include/esp-idf/components/**",
                /* ===== 关键：目标相关 ===== */
                "C:/Users/82542/test_include/esp-idf/components/soc/esp32s3/include",
                "C:/Users/82542/test_include/esp-idf/components/hal/esp32s3/include",
                /* FreeRTOS Xtensa */
                "C:/Users/82542/test_include/esp-idf/components/freertos/FreeRTOS-Kernel/portable/xtensa/include",
                "C:/Users/82542/test_include/esp-idf/components/freertos/FreeRTOS-Kernel/include",
                /* 编译时生成 或 编译时下载依赖 */
                "C:\\Users\\82542\\test_include\\include",
                /* MicroPython */
                "C:/Users/82542/test_include/micropython/ports/esp32/**",
                "C:/Users/82542/test_include/micropython",
                "C:/Users/82542/test_include/micropython/ports/esp32",
                "C:/Users/82542/test_include/micropython/extmod"
            ]
        }
    ]
}
...
如有遗漏在此参考  [lrlbh/cmaera_lr: micropython的ESP32S3固件，添加了C扩展，PY扩展，sdkconfig配置](https://github.com/lrlbh/cmaera_lr)
...
~~~shell
# 如果没有代理，去镜像网络的WSL中用下载
git clone -b v5.5.1 --recursive https://github.com/espressif/esp-idf.git
cd .\esp-idf\

# cmd 安装 ESP-IDF 的工具链和依赖（这一步会下载工具链、Python 虚拟环境等，大约 1-2GB）
# 如果应用商店py别名有问题，在这里复制一个程序加个别名   C:\Users\82542\AppData\Local\Programs\Python\Launcher
./install.bat esp32s3 # 如果想支持所有 ESP32 系列，用 ./install.bat all

# cmd 激活环境
./export.bat

# cmd gcc位置 
where xtensa-esp32s3-elf-gcc # 智能提示可能需要
